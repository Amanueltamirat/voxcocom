...
function Header() {
  return (
    <div className='flex justify-between px-10 bg-white shadow-sm shadow-gray-300'>
        <div>
            <h2 className='flex flex-col gap-0 py-4'><span><strong className='text-indigo-900 text-3xl'>voxco  </strong><small className='text-indigo-900 text-3xl'>number ordering portal</small></span> </h2>
