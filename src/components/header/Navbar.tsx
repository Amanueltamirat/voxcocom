    ...
    <div className={`flex bg-black text-white px-10 py-2 justify-between sticky z-50 ${isAdmin ? 'hidden': ''}`}>
        ...
        <div className='flex items-center sm:hidden md:hidden lg:flex xl:flex nav-menu'>
           <nav className='flex gap-5'>
              <Link className='text-sm hover:text-gray-500' to='/products'>Voxcom Products</Link>
              <Link className='text-sm hover:text-gray-500' to='/voxco-number'>Voxcom Numbers</Link>
              <div className='text-sm hover:text-gray-500 flex items-center'>
              ...
              <div className='flex gap-1 items-center text-sm hover:text-gray-500'>
                  <div className="dropdown cursor-pointer">
                  <div className='dropbtn'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 text-white">
                  <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
