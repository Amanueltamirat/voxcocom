...
const y = useTransform(scrollY,[0,10],[0,10]);
  ...
  return (
     <div className='my-10 mt-20 grid xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 gap-10'>
          ...
          <motion.div className=' bg-white shadow-md shadow-slate-300  group relative transition duration-300 overflow-hiddemotion.n'>
                <div className='transition duration-0 px-10 pt-10 pb-20 h-full relative'>
                    <h2 className='text-xl pb-5 font-semibold text-center'>VoxcoNumbers</h2>
                    <img className='h-[90%] w-[100%] rounded-3xl' src="/hero-1.jpg" alt="" />
                    <motion.div variants={variants} initial="initial" whileInView='animate'  ref={ref}  className='absolute top-[30%] left-20 bg-[rgba(0,0,0,0.4)] p-5 rounded-2xl'>
                        <motion.div variants={variants} initial="initial" whileInView='animate' >                    
                            <motion.h2  className='text-2xl font-semibold text-white'>Find Your Perfect Number</motion.h2>
                            <motion.p className='text-white'>Local, Toll-Free and Vanity Options</motion.p>
                ...
                <div  className='absolute top-10 left-0 hidden group-hover:block group-hover:opacity-100 transform  transition-all duration-1000 ease-in-out backdrop-blur-md h-[100%] px-10'>
                    ...
                    <Link to={'/'} className='bg-orange-600 rounded-l-full rounded-r-full text-white py-4 px-5 ml-[30%]'>Learn More</Link>
                </div>
            </motion.div>

            <motion.div className=' bg-white shadow-md shadow-slate-300  group relative transition duration-300 overflow-hidden'>
                <div className='transition duration-0 px-10 pt-10 pb-20 h-full relative'>
                    <h2 className='text-xl pb-5 font-semibold text-center'>VexcoMessaging</h2>
                    <img className='h-[90%] w-[100%] rounded-3xl' src="/hero-2.jpg" alt="" />
                     <motion.div variants={variants} initial="initial" whileInView='animate'  ref={ref}  className='absolute top-[30%] left-20 bg-[rgba(0,0,0,0.4)] p-5 rounded-2xl'>
                            <motion.h2 className='text-2xl font-semibold text-white'>Global numbers for Global messaging</motion.h2>
                            <motion.p className='text-white'>Local, Toll-Free and Vanity Options</motion.p>
                            <motion.button className='bg-indigo-800 text-white my-2'>Telespham</motion.button>
                    </motion.div>
                </div>
                ...
                <div  className='absolute top-10 left-0 hidden group-hover:block group-hover:opacity-100 transform  transition-all duration-1000 ease-in-out backdrop-blur-md h-[100%] px-10'>
                    <div className='flex flex-col items-center  gap-5 mb-5 mt-5'>
                        <div>
                            <h2 className='text-xl font-semibold'>VexcoMessaging</h2>
                    ...
                    <Link to={'/'} className='bg-orange-600 rounded-l-full rounded-r-full text-white py-4 px-5 z-10 ml-[30%]'>Learn More</Link>
                </div>
            </motion.div>
        </div>
  )
